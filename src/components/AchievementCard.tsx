...
export const achievements = [
  ...
  // Future Works
  {
    ...
    description: "ഗവ. ഗേൾസ് ഹൈസ്കൂളിന് സമീപം 63.6 സെൻ്റ് ഭൂമിയിൽ അഞ്ചു നിലകളിലായി 68,000 സ്ക്വയർ ഫീറ്റ് വിസ്തൃതി",
    icon: Building2,
  ...
  },
  {
    ...
    description: "223 കോടി രൂപയുടെ DPR കിഫ്ബിക്ക് സമർപ്പിച്ചു. 27.60 കോടി രൂപയുടെ മേൽപ്പാലം.",
    amount: "223 കോടി",
    icon: Route,
